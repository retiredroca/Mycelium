...
pub struct GossipMessage {
    pub id: String,
    pub msg_type: super::sov_protocol::MsgType,
    pub sender: PeerId,
    pub timestamp: i64,
...
impl GossipMessage {
    pub fn new(msg_type: super::sov_protocol::MsgType, payload: GossipPayload) -> Self {
        Self {
...
mod tests {
    ...
    fn test_gossip_message_ttl() {
        let mut msg = GossipMessage::new(
            super::super::sov_protocol::MsgType::PostCreated,
